			...
			<section className="pt-0">
				<div className="container position-relative">
					<div className="tiny-slider arrow-round arrow-hover arrow-dark">
						<div className="tiny-slider-inner rounded-2" data-autoplay="true" data-arrow="true" data-dots="true" data-items="1" >
							<div >
								<img src="images/bg2.png" className="rounded-3" alt=""/>
							</div>
							<div>
								<img src="images/bg2.png" className="rounded-3" alt=""/>
							</div>
						...
						<div className="container">
							<div className="row mb-4">
								<div className="col-12 text-center">
									<h3 className="mb-0">Our Best Packages</h3>
								</div>
							</div>
								...
								<div className="col-md-6 col-lg-3">
									<div className="card border border-primary">
										<div className="card-header d-flex justify-content-between align-items-center border-bottom p-4">
											<div>
												<h6 className="mb-0 text-primary">Wind</h6>
												<div className="hstack gap-2">
													<span className="h3 plan-price mb-0" data-monthly-price="$20" data-annual-price="$570">10 Mbps</span>
												</div>
											</div>
										</div>
										...
										<div className="card-body p-4">
											<ul className="list-unstyled mb-0">
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>Upto 100 Mbps IX</li>
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>4K Streaming</li>
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>Private IP</li>
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>24/7 dedicated Support</li>
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>Optical Fiber connection</li>
												<li ><div className="">
													<span className="h4 plan-price mb-0" data-monthly-price="$59" data-annual-price="$840">500</span>
													<span className="h6 fw-light mb-0">Tk/Month</span>
												</div></li>
											</ul>
										</div>
										<div className="card-footer p-4 pt-0">
											<a href="#" className="btn btn-success w-100 mb-0">Get Started</a>
										</div>
									</div>
								</div>
								<div className="col-md-6 col-lg-3">
									<div className="card border border-primary">
										<div className="card-header d-flex justify-content-between align-items-center border-bottom p-4">
											<div>
												<h6 className="mb-0 text-primary">Lightning</h6>
												<div className="hstack gap-2">
													<span className="h3 plan-price mb-0" data-monthly-price="$20" data-annual-price="$570">20 Mbps</span>
												</div>
											</div>
										...
										<div className="card-body p-4">
											<ul className="list-unstyled mb-0">
												...
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>Optical Fiber connection</li>
												<li ><div className="">
													<span className="h4 plan-price mb-0" data-monthly-price="$59" data-annual-price="$840">800</span>
													<span className="h6 fw-light mb-0">Tk/Month</span>
												</div></li>
											</ul>
										</div>
									...
									<div className="card border border-primary">
										<div className="card-header d-flex justify-content-between align-items-center border-bottom p-4">
											<div>
												<h6 className="mb-0 text-primary">Wind</h6>
												<div className="hstack gap-2">
													<span className="h3 plan-price mb-0" data-monthly-price="$20" data-annual-price="$570">40 Mbps</span>
												</div>
											</div>
										...
										<div className="card-body p-4">
											<ul className="list-unstyled mb-0">
												...
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>4K Streaming</li>
												<li className="mb-2"><i className="bi bi-check-circle text-success me-2"></i>Private IP</li>
												<li className="mb-2"><i className="bi bi-x-circle text-danger me-2"></i>24/7 dedicated Support</li>
												<li className="mb-2"><i className="bi bi-x-circle text-danger me-2"></i>Optical Fiber connection</li>
												<li ><div className="">
													<span className="h4 plan-price mb-0" data-monthly-price="$59" data-annual-price="$840">1000</span>
													<span className="h6 fw-light mb-0">Tk/Month</span>
												</div></li>
											</ul>
										</div>
									...
									<div className="card border border-primary">
										<div className="card-header d-flex justify-content-between align-items-center border-bottom p-4">
											<div>
												<h6 className="mb-0 text-primary">Wind</h6>
												<div className="hstack gap-2">
													<span className="h3 plan-price mb-0" data-monthly-price="$20" data-annual-price="$570">60 Mbps</span>
												</div>
											</div>
										...
										<div className="card-body p-4">
											<ul className="list-unstyled mb-0">
												...
												<li className="mb-2"><i className="bi bi-x-circle text-danger me-2"></i>Optical Fiber connection</li>
												<li><div className="">
													<span className="h4 plan-price mb-0" data-monthly-price="$59" data-annual-price="$840">1500</span>
													<span className="h6 fw-light mb-0">Tk/Month</span>
												</div></li>
											</ul>
										</div>
							...
							<div className="row g-4 text-center">
								<div className="col-sm-6 col-lg-4 col-xl-3">
									<div className="card bg-success bg-opacity-10 h-100 p-4">
										...
										<div className="card-body mt-2 p-0">
											...
											<h4 className="mb-1">100% OFF</h4>
											<h6 className="fw-normal">Installation Charge</h6>
											
											<div className="d-flex justify-content-between align-items-center mt-4">
												<div className="bg-primary bg-opacity-10 border border-2 border-primary border-dashed rounded-2 px-3 py-2">
													<h5 className="fw-normal user-select-all mb-0">EID2023</h5>
												</div>
												<a href="#" className="btn btn-lg btn-white btn-round mb-0"><i className="bi bi-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-sm-6 col-lg-4 col-xl-3">
									<div className="card bg-danger bg-opacity-10 h-100 p-4">
										<h5> Refer and Win!</h5>
										<div className="card-body mt-2 p-0">
											<span className="mb-1">Win</span>
											<h4 className="mb-1">500 Tk</h4>
											<h6 className="fw-normal">On Every Successful Refferal</h6>
											
											<div className="d-flex justify-content-between align-items-center mt-4">
												<div className="bg-primary bg-opacity-10 border border-2 border-primary border-dashed rounded-2 px-3 py-2">
													<h5 className="fw-normal user-select-all mb-0">Avail Now</h5>
												</div>
												<a href="#" className="btn btn-lg btn-white btn-round mb-0"><i className="bi bi-arrow-right"></i></a>
											</div>
										</div>
									...
									<div className="row align-items-center position-relative">
										<div className="col-lg-8">
											<div className="d-flex">
												...
												<img src="assets/images/element/04.svg" className="h-40px ms-3" alt=""/>
											</div>
											<p className="mb-3 mb-lg-0">He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty gay assistance joy.</p>
										</div>
										<div className="col-lg-4 text-lg-end">
											<a href="flight-list.html" className="btn btn-lg btn-dark mb-0">Register Now!</a>
										</div>
									</div> 
								</div>
							</div>
